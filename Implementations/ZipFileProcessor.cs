...
namespace AzUnzipEverything.Implementations
{
    public class ZipFileProcessor : FileProcessorBase
    {
        ...
        public ZipFileProcessor(CloudBlobContainer destinationContainer, SecretSettings secretSettings, ILogger<FileProcessorBase> logger, ICosmosDbService cosmosDbService) : base(destinationContainer, logger, cosmosDbService)
        {
